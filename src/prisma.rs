...
pub mod duck {
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(|(title, story, duck_icon_url, mut _params)| {
                    _params.push(title::set(title));
                    _params.push(story::set(story));
                    _params.push(duck_icon_url::set(duck_icon_url));
                    _params
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (title, story, duck_icon_url, mut _params): (
                ::prisma_client_rust::serde_json::Value,
                ::prisma_client_rust::serde_json::Value,
                String,
                Vec<SetParam>,
