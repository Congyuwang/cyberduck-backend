    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(
                    |(title, story, location, topics, duck_icon_url, mut _params)| {
                        _params.push(title::set(title));
                        _params.push(story::set(story));
                        _params.push(location::set(location));
                        _params.push(topics::set(topics));
